               ...
               children: [
                 Padding(
                   ...
                   child: Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                       Text("Rooms",style:TextStyle(color:Colors.black,fontSize: 25.0,fontWeight: FontWeight.bold)),
                        Text("Beautiful rooms we have for you",style:TextStyle(color:Colors.black,fontSize: 15.0)),
                     ],
                   ),
                 ),
               ],
